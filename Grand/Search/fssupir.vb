...
Public Class fssupir
    ...
    Private Sub cari()
        ...
        If issales = False Then
            sql = "select * from ms_pegawai where aktif=1 and bagian like 'SUPIR%'"
        Else
            sql = "select * from ms_pegawai where aktif=1 and (bagian like 'SUPIR%' or bagian='SALES')"
        End If
