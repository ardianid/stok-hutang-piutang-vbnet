...
Public Class fs_notrans
    Private dvmanager As Data.DataViewManager
    Private dv1 As Data.DataView

    Private Sub cari()

        Dim sql As String = "select nobukti,tgl,tglmuat,tglkirim,ms_pegawai.nama_karyawan as supir,trrekap_to.nopol,ms_jalur_kirim.nama_jalur " & _
        "from trrekap_to inner join ms_pegawai on trrekap_to.kd_supir=ms_pegawai.kd_karyawan " & _
        "inner join ms_jalur_kirim on trrekap_to.kd_jalur=ms_jalur_kirim.kd_jalur " & _
        "where sbatal=0 and smuat=0"
