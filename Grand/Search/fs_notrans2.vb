...
Public Class fs_notrans2
    Private dvmanager As Data.DataViewManager
    Private dv1 As Data.DataView

    Private Sub cari()

        Dim sql As String = "select trspm.nobukti,trspm.tanggal,trspm.tglmuat,trspm.tglberangkat,ms_pegawai.nama_karyawan as supir,trspm.nopol " & _
