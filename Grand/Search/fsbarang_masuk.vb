...
Public Class fsbarang_masuk
    Private dvmanager As Data.DataViewManager
    Private dv1 As Data.DataView

    Private Sub cari()

        Dim sql As String = "select a.nobukti,a.tanggal,a.tglmuat,a.tglberangkat,a.nobukti_gd,a.nopol,b.nama_karyawan,a.kd_gudang " & _
        "from tradm_gud a inner join ms_pegawai b on a.kd_supir=b.kd_karyawan " & _
        "where a.jenistrans='TR PEMB' and a.sambil=0"
    ...
    Public ReadOnly Property get_NoSJ As String
        Get
