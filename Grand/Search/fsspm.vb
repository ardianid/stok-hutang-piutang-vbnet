...
Public Class fsspm
    ...
    Private Sub cari()
        ...
        If Not tfind.Text.Trim.Equals("") Then
            ...
            Select Case cb_criteria.SelectedIndex
                ...
                Case 2 ' kd_gudang
                    sql = String.Format("{0} and  trspm.kd_gudang like '%{1}%'", sql, tfind.Text.Trim)
                Case 3 ' supir
    ...
    Public ReadOnly Property get_NoSPM As String
        Get
    ...
    Public ReadOnly Property get_Gudang As String
        Get
            ...
            If dv1.Count <= 0 Then
                ...
                Exit Property
            End If
            Return dv1(Me.BindingContext(dv1).Position)("kd_gudang").ToString
        End Get
    End Property
