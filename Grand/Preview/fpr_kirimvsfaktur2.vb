...
Public Class fpr_kirimvsfaktur2
    ...
    Private Sub load_print()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_kirimvsfaktur
            ds = Clsmy.GetDataSet(sql, cn)

            Dim ops As New System.Drawing.Printing.PrinterSettings
            Dim rrekap As New r_kirimvsfaktur() With {.DataSource = ds.Tables(0)}
    ...
    Private Sub fpr_kirimvsfaktur2_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        load_print()
    End Sub
