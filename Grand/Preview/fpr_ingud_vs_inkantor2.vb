...
Public Class fpr_ingud_vs_inkantor2
    ...
    Private Sub load_print()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_ingud_vs_inkantor
            ds = Clsmy.GetDataSet(sql, cn)

            Dim ops As New System.Drawing.Printing.PrinterSettings
            Dim rrekap As New r_ingud_vs_inkantor() With {.DataSource = ds.Tables(0)}
            rrekap.xuser.Text = String.Format("User : {0} | Tgl : {1}", userprog, Date.Now)
            rrekap.lbtanggal.Text = periode
