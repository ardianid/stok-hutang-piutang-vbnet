...
Public Class fpr_returbelumpot
    ...
    Private Sub btload_Click(sender As System.Object, e As System.EventArgs) Handles btload.Click
        ...
        Dim sql As String = String.Format("select trretur.nobukti,trretur.tanggal,trretur.tgl_masuk,ms_toko.nama_toko, " & _
        "ms_barang.nama_lap, trretur2.qty, trretur2.harga, trretur2.disc_rp, trretur2.jumlah " & _
        ...
        "where trretur.spotong=0 and trretur.sbatal=0 and trretur.netto<>0 and trretur2.jumlah<>0  and trretur.tanggal>='{0}' and trretur.tanggal<='{1}'", convert_date_to_eng(ttgl.EditValue), convert_date_to_eng(ttgl2.EditValue))
        ...
        Dim fs As New fpr_returbelumpot2 With {.WindowState = FormWindowState.Maximized, .sql = sql, .tgl = periode}
        fs.ShowDialog()
