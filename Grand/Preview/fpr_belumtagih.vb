...
Public Class fpr_belumtagih
    ...
    Private Sub btload_Click(sender As System.Object, e As System.EventArgs) Handles btload.Click
        ...
        Dim sql As String = "SELECT     trfaktur_to.nobukti, trfaktur_to.tanggal,trfaktur_to.tgl_tempo, " & _
         "case when DATEDIFF(day,trfaktur_to.tanggal,GETDATE()) <= 15 then " & _
            "trfaktur_to.netto-(trfaktur_to.jmlbayar + trfaktur_to.jmlgiro_real) " & _
         "else 0 " & _
         "end as '15hari', " & _
         "case when DATEDIFF(day,trfaktur_to.tanggal,GETDATE())> 15 and DATEDIFF(day,trfaktur_to.tanggal,GETDATE()) <=30 then " & _
            "trfaktur_to.netto-(trfaktur_to.jmlbayar + trfaktur_to.jmlgiro_real) " & _
     "else 0 " & _
     "end as '30hari', " & _
     "case when DATEDIFF(day,trfaktur_to.tanggal,GETDATE()) >30 then " & _
        "trfaktur_to.netto-(trfaktur_to.jmlbayar + trfaktur_to.jmlgiro_real) " & _
     "else 0 " & _
     "end	as '30hariplus', " & _
     "DATEDIFF(day,trfaktur_to.tanggal,GETDATE()) as jmltempo,trfaktur_to.netto, " & _
        "trfaktur_to.jmlgiro, " & _
         "ms_toko.kd_toko, ms_toko.nama_toko, ms_pegawai.kd_karyawan, ms_pegawai.nama_karyawan " & _
        ...
        "WHERE trfaktur_to.sbatal = 0 " & _
        "and ((trfaktur_to.netto - (trfaktur_to.jmlbayar + trfaktur_to.jmlgiro_real))> 0) " & _
        "and trfaktur_to.statkirim='TERKIRIM'"
        ...
        Dim fs As New fpr_belumtagih2 With {.WindowState = FormWindowState.Maximized, .sql = sql}
        fs.ShowDialog()
