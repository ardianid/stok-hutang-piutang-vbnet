...
Public Class fpr_penjproduk_sup
    ...
    Private Sub tkd_sales_EditValueChanged(sender As Object, e As System.EventArgs) Handles tkd_sales.EditValueChanged
        If tkd_sales.Text.Trim.Length > 0 Then
            ...
            Dim sql As String = String.Format("select * from ms_pegawai where aktif=1 and (bagian='SUPIR' or bagian='SALES') and kd_karyawan='{0}'", tkd_sales.Text.Trim)
    ...
    Private Sub btload_Click(sender As System.Object, e As System.EventArgs) Handles btload.Click
        ...
        "ms_toko.nama_toko, ms_toko.alamat_toko, v_kirim_supir0.kd_karyawan, v_kirim_supir0.nama_karyawan, trfaktur_to2.kd_barang, ms_barang.nama_barang, " & _
        ...
        "FROM  v_kirim_supir0 INNER JOIN ms_barang INNER JOIN ms_toko INNER JOIN " & _
        ...
        "v_kirim_supir0.nobukti = trfaktur_to.nobukti LEFT OUTER JOIN " & _
        ...
        If tkd_sales.Text.Trim.Length > 0 Then
            sql = String.Format("{0} and v_kirim_supir0.kd_karyawan='{1}'", sql, tkd_sales.Text.Trim)
        End If
        ...
        "ms_toko.nama_toko, ms_toko.alamat_toko, v_kirim_supir0.kd_karyawan, v_kirim_supir0.nama_karyawan, trfaktur_to5.kd_barang, ms_barang.nama_barang, " & _
        ...
        "v_kirim_supir0 ON trfaktur_to.nobukti = v_kirim_supir0.nobukti " & _
        ...
        "inner join v_kirim_supir0 on trfaktur_to.nobukti=v_kirim_supir0.nobukti " & _
        "where  " & _
        ...
        If tkd_sales.Text.Trim.Length > 0 Then
            sql = String.Format("{0} and v_kirim_supir0.kd_karyawan='{1}')", sql.Substring(0, sql.Length - 1), tkd_sales.Text.Trim)
        End If
        ...
        "ms_toko.nama_toko, ms_toko.alamat_toko, v_kirim_supir0.kd_karyawan, v_kirim_supir0.nama_karyawan, ms_barang.kd_barang, ms_barang.nama_barang, " & _
        ...
        "FROM         v_barang_jaminan_kembali2 INNER JOIN " & _
                      ...
                      "ms_toko ON trfaktur_to.kd_toko = ms_toko.kd_toko INNER JOIN " & _
                      "v_kirim_supir0 ON trfaktur_to.nobukti = v_kirim_supir0.nobukti LEFT OUTER JOIN " & _
        ...
        Dim fs As New fpr_penjproduk2 With {.WindowState = FormWindowState.Maximized, .sql = sql, .tgl = periode, .jdlkary = 2}
        fs.ShowDialog()
