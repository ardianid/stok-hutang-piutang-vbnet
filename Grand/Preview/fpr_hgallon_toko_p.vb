...
Public Class fpr_hgallon_toko_p
    ...
    Private Sub btload_Click(sender As System.Object, e As System.EventArgs) Handles btload.Click
        ...
        Dim fs As New fpr_hgallon_toko2 With {.WindowState = FormWindowState.Maximized, .tgl1 = ttgl.EditValue, .tgl2 = ttgl2.EditValue, .kdtoko = tkode_tko.Text.Trim, .jenislap = 2}
        fs.ShowDialog()
