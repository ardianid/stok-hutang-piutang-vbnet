...
Public Class fpr_realisasi_krm2

    Public sql As String
    Public tgl As String
    Public judul As String
    Public subjudul As String
    ...
    Private Sub load_print()
        ...
        Try
            ...
            Dim ds As DataSet = New ds_realisasi_krm
            ds = Clsmy.GetDataSet(sql, cn)

            Dim ops As New System.Drawing.Printing.PrinterSettings
            Dim rrekap As New r_realisasi_krm() With {.DataSource = ds.Tables(0)}
            rrekap.xuser.Text = String.Format("User : {0} | Tgl : {1}", userprog, Date.Now)
            rrekap.xperiode.Text = tgl
            rrekap.xjudul.Text = judul
            ' rrekap.xjudul_subtot.Text = subjudul
