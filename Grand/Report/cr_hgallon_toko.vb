...
Public Class cr_hgallon_toko
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Grand.cr_hgallon_toko.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_hgallon_toko
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_hgallon_toko = New cr_hgallon_toko()
        rpt.Site = Me.Site
        Return rpt
    End Function
