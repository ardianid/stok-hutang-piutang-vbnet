...
Public Class fbayar2_lebih2
    ...
    Private Sub open_retur()
        ...
        Dim sql As String = "select trfaktur_to.nobukti,trfaktur_to.tanggal,trfaktur_to.tgl_tempo,trfaktur_to.jmlkelebihan from trfaktur_to inner join ms_toko on trfaktur_to.kd_toko=ms_toko.kd_toko " & _
            "where trfaktur_to.jmlkelebihan > trfaktur_to.jmlkelebihan_pot"
        ...
        If tfind.Text.Trim.Length > 0 Then
            ...
            sql = String.Format("{0} where trfaktur_to.nobukti like '%{1}%'", sql, tfind.Text.Trim)
