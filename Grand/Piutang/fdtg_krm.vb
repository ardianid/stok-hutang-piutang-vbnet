...
Public Class fdtg_krm
    ...
    Private Sub isi_sales()
        ...
        sql = "select * from ms_jalur_kirim"
    ...
    Private Sub isi()
        ...
        Dim rows() As DataRow = dta.Select(String.Format("kd_jalur='{0}'", tsales.EditValue))

        If rows.Length > 0 Then
            MsgBox("Jalur sudah ada dalam daftar", vbOKOnly + vbInformation, "Informasi")
            tsales.Focus()
            Return
        End If

        Dim orow As DataRowView = dv.AddNew
        orow("kd_jalur") = tsales.EditValue
        orow("nama_jalur") = tsales.Text.Trim
