...
Public Class fbayar_sw3
    ...
    Private Sub tnosewa_Validated(sender As System.Object, e As System.EventArgs) Handles tnosewa.Validated
        ...
        If tnosewa.Text.Trim.Length > 0 Then
            ...
            Dim sql As String = String.Format("select nobukti,tanggal,netto from trsewa where netto > jmlbayar and sbatal=0 and nobukti='{0}' and kd_toko='{1}'", tnosewa.Text.Trim, kdtoko)
    ...
    Private Sub bts_supir_Click(sender As System.Object, e As System.EventArgs) Handles bts_supir.Click
        ...
        Dim fs As New fssewa With {.StartPosition = FormStartPosition.CenterParent, .WindowState = FormWindowState.Normal, .kdtoko = kdtoko}
        fs.ShowDialog(Me)
