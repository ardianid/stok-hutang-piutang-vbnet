...
Public Class fgiro_cair
    ...
    Private Sub opendata()
        ...
        Dim sql As String = String.Format("SELECT nobukti, tanggal, total, note, sbatal FROM tr_bg where jenis=1 and tanggal >='{0}' and  tanggal <='{1}'", convert_date_to_eng(tglperiod1), convert_date_to_eng(tglperiod2))
    ...
    Private Sub cari()
        ...
        sql = String.Format("SELECT nobukti, tanggal, total, note, sbatal FROM tr_bg where jenis=1 and tanggal >='{0}' and  tanggal <='{1}'", convert_date_to_eng(tglperiod1), convert_date_to_eng(tglperiod2))
    ...
    Private Sub hapus()
        ...
        Try
            ...
            Clsmy.InsertToLog(cn, "btgiro_cair", 0, 0, 1, 0, dv1(Me.BindingContext(bs1).Position)("nobukti").ToString, dv1(Me.BindingContext(bs1).Position)("tanggal").ToString, sqltrans)
            ...
            While drd.Read
                ...
                If dr_lain.HasRows Then
                    ...
                    While dr_lain.Read
                        ...
                        Clsmy.Insert_HistPiutang_Outl(cn, sqltrans, dr_lain("nobukti").ToString, nobukti, dv1(bs1.Position)("tanggal").ToString, dr_lain("kd_toko").ToString, total_up, 0, "Pencairan Giro (Batal)")
    ...
    Private Sub tsadd_Click(sender As System.Object, e As System.EventArgs) Handles tsadd.Click
        ...
        Using fkar2 As New fgiro_cair2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = True, .position = 0, .statview = False, .jenistrans = 1}
            fkar2.ShowDialog()
            IsLoadForm = False
        End Using
    ...
    Private Sub tsedit_Click(sender As System.Object, e As System.EventArgs) Handles tsedit.Click
        ...
        Using fkar2 As New fgiro_cair2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position, .statview = False, .jenistrans = 1}
            fkar2.ShowDialog()
    ...
    Private Sub tsview_Click(sender As System.Object, e As System.EventArgs) Handles tsview.Click
        ...
        Using fkar2 As New fgiro_cair2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position, .statview = True, .jenistrans = 1}
