...
Public Class fsewa3
    ...
    Private Sub tbarang_EditValueChanged(sender As Object, e As System.EventArgs) Handles tbarang.EditValueChanged
        ...
        tharga.EditValue = dvs(tbarang.ItemIndex)("hargasewa").ToString
    ...
    Private Sub isi_barang()
        ...
        sql = String.Format("select a.kd_barang,b.nama_barang,b.satuan1,b.satuan2,b.satuan3,a.jmlstok1,a.jmlstok2,a.jmlstok3,b.qty1,b.qty2,b.qty3,b.hargasewa" & _
            " from ms_barang2 a inner join ms_barang b on a.kd_barang=b.kd_barang where b.jenis='FISIK' and b.ssewa=1 and a.kd_gudang='{0}'", tgudang.EditValue)
