...
Public Class fkec
    ...
    Private Sub opendata()
        ...
        Const sql As String = "select top 500 a.kd_kec,a.nama_kec,b.kd_kab,b.nama_kab from ms_kec a inner join ms_kab b on a.kd_kab=b.kd_kab"
    ...
    Private Sub cari()
        ...
        sql = "select a.kd_kec,a.nama_kec,b.kd_kab,b.nama_kab from ms_kec a inner join ms_kab b on a.kd_kab=b.kd_kab where "

        Select Case tcbofind.SelectedIndex
            Case 0 ' kode kec
                sql = String.Format("{0} a.kd_kec='{1}'", sql, tfind.Text.Trim)
            Case 1 ' nama kec
    ...
    Private Sub hapus()
        ...
        Dim sql As String = String.Format("delete from ms_kec where kd_kec='{0}'", dv1(Me.BindingContext(bs1).Position)("kd_kec").ToString)
        ...
        Try
            ...
            Clsmy.InsertToLog(cn, "btkec", 0, 0, 1, 0, dv1(Me.BindingContext(bs1).Position)("kd_kec").ToString, "", sqltrans)
    ...
    Private Sub tsadd_Click(sender As System.Object, e As System.EventArgs) Handles tsadd.Click
        Using fkar2 As New fkec2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = True, .position = 0}
            fkar2.ShowDialog()
        End Using
    End Sub
    ...
    Private Sub tsedit_Click(sender As System.Object, e As System.EventArgs) Handles tsedit.Click
        ...
        Using fkar2 As New fkec2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position}
            fkar2.ShowDialog()
        End Using
