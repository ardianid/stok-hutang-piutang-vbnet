...
Public Class fjalur_od2
    ...
    Private Sub simpan()
        ...
        Try
            ...
            Dim sqlc As String = String.Format("select kd_jalur from ms_jalur where kd_jalur='{0}'", tkode.Text.Trim)
            Dim sql_insert As String = String.Format("insert into ms_jalur (kd_jalur,nama_jalur) values('{0}','{1}')", tkode.Text.Trim, tnama.Text.Trim)
            Dim sql_update As String = String.Format("update ms_jalur set nama_jalur='{0}' where kd_jalur='{1}'", tnama.Text.Trim, tkode.Text.Trim)
                ...
                If dread.HasRows Then
                    If dread.Read Then
                        ...
                        If kdka.Trim.Length = 0 Then
                            ...
                            Clsmy.InsertToLog(cn, "btjalur", 1, 0, 0, 0, tkode.Text.Trim, "", sqltrans)
            ...
            Else
                ...
                Clsmy.InsertToLog(cn, "btjalur", 0, 1, 0, 0, tkode.Text.Trim, "", sqltrans)
