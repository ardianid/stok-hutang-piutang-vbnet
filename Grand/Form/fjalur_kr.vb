...
Public Class fjalur_kr
    ...
    Private Sub cari()
        ...
        sql = "select * from ms_jalur_kirim where "
    ...
    Private Sub hapus()
        ...
        Dim sql As String = String.Format("delete from ms_jalur_kirim where kd_jalur='{0}'", dv1(Me.BindingContext(bs1).Position)("kd_jalur").ToString)
        ...
        Try
            ...
            Clsmy.InsertToLog(cn, "btjalur_kr", 0, 0, 1, 0, dv1(Me.BindingContext(bs1).Position)("kd_jalur").ToString, "", sqltrans)
    ...
    Private Sub tsadd_Click(sender As System.Object, e As System.EventArgs) Handles tsadd.Click
        Using fkar2 As New fjalur_kr2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = True, .position = 0}
            fkar2.ShowDialog()
        End Using
    End Sub
    ...
    Private Sub tsedit_Click(sender As System.Object, e As System.EventArgs) Handles tsedit.Click
        ...
        Using fkar2 As New fjalur_kr2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position}
            fkar2.ShowDialog()
        End Using
