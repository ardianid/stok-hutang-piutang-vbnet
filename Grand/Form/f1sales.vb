...
Public Class f1sales
    ...
    Private Sub opendata()
        ...
        Const sql As String = "select a.kd_sales1,b.kd_karyawan,b.nama_karyawan,a.aktif,a.note from ms_sales1 a inner join ms_pegawai b on a.kd_karyawan=b.kd_karyawan"
    ...
    Private Sub cari()
        ...
        sql = "select a.kd_sales1,b.kd_karyawan,b.nama_karyawan,a.aktif,a.note from ms_sales1 a inner join ms_pegawai b on a.kd_karyawan=b.kd_karyawan where "

        Select Case tcbofind.SelectedIndex
            Case 0 ' kode
                sql = String.Format("{0} a.kd_sales1='{1}'", sql, tfind.Text.Trim)
            Case 1 ' nama
                sql = String.Format("{0} b.nama_karyawan like '%{1}%'", sql, tfind.Text.Trim)
        End Select
    ...
    Private Sub hapus()
        ...
        Dim sql As String = String.Format("delete from ms_sales1 where kd_sales1='{0}'", dv1(Me.BindingContext(bs1).Position)("kd_sales1").ToString)
        ...
        Try
            ...
            Clsmy.InsertToLog(cn, "btlevsales1", 0, 0, 1, 0, dv1(Me.BindingContext(bs1).Position)("kd_sales1").ToString, "", sqltrans)
    ...
    Private Sub tsadd_Click(sender As System.Object, e As System.EventArgs) Handles tsadd.Click
        Using fkar2 As New f1sales2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = True, .position = 0}
            fkar2.ShowDialog()
        End Using
    End Sub
    ...
    Private Sub tsedit_Click(sender As System.Object, e As System.EventArgs) Handles tsedit.Click
        ...
        Using fkar2 As New f1sales2 With {.StartPosition = FormStartPosition.CenterParent, .dv = dv1, .addstat = False, .position = bs1.Position}
            fkar2.ShowDialog()
        End Using
